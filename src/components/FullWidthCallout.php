 ...
 * @since     0.0.1
 */
class FullWidthCallout extends BaseComponent implements ComponentInterface
{
    /**
     * @var array config
     */
    ...
    {
        $file = __DIR__ . "/configs/FullWidthCallout.yaml";
